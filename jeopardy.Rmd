...
and exploration using Open Source R.
...
```{r eval = FALSE}
jeopardyDataRaw <- jscrapeDirect(id=1:5200)
```
...
uGender <- uGenderList$gender
#
# Code "male" -> "M", "female" -> "F"
uGender <- ifelse(uGender == "male", "M", uGender)
uGender <- ifelse(uGender == "female", "F", uGender)
uPropMale <- uGenderList$proportion_male
uPropFemale <- uGenderList$proportion_female
#
...
(the top 6, the Date is the date of their final game):
