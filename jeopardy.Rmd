...
Note that the sum of `NumAttempted` across all three players in a game is not the same
as the total number of clues tried in that game since after an incorrect response by a players,
